...
public class MessageController implements CommunityConstant {
    ...
    public String getLetterList(Model model, Page page) {
        ...
        if (conversationList != null) {
            for (Message message : conversationList) {
                ...
                map.put("letterCount", messageService.findLLetterCount(message.getConversationId()));
    ...
    public String getLetterDetail(@PathVariable("conversationId") String conversationId, Page page, Model model) {
        ...
        page.setLimit(5);
        page.setRows(messageService.findLLetterCount(conversationId));
    ...
    public String getNoticeList(Model model) {
        ...
        if (message != null) {
            ...
            String content = HtmlUtils.htmlUnescape(message.getContent());//处理content中jason字符串的转义字符
